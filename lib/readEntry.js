 ...
 * Calls callback with entry or error.
...
/**
 * Search for end of file data in ZIP.
 * @param {Object} zipFile - `ZipFile` object
 * @param {Object} entry - `Entry` object
 * @param {number} size - Size of compressed data estimate (may be wrong by a multiple of 4 GiB)
 * @param {number} offset - Offset to look for Data Descriptor
 * @param {Function} cb - Callback
 * @returns {undefined}
 */
 ...
 * Check if entry count is now certain and emit entry.
 * @param {Object} zipFile - `ZipFile` object
 * @param {Object} entry - `Entry` object
 * @param {Function} cb - Callback
 * @returns {undefined}
...
/**
 * Error finding local file header. Emit error.
 * @param {Object} zipFile - `ZipFile` object
 * @returns {undefined}
 */
